...
public class RSATest {
    ...
    public static void main(String[] args) {
        try {
            ...
            String encryptData = t.encrypt(data, t.getPublicKey(publicKey));
            System.out.println("加密后内容:" + encryptData);
            // RSA解密
            String decryptData = t.decrypt(encryptData, t.getPrivateKey(privateKey));
            System.out.println("解密后内容:" + decryptData);

            // RSA签名
            String sign = t.sign(data, t.getPrivateKey(privateKey));
            // RSA验签
            boolean result = t.verify(data, t.getPublicKey(publicKey), sign);
